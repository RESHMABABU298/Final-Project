...
import 'package:todo_final_project/todo_login.dart';
...
class _SplashScreenState extends State<SplashScreen> {
 ...
 void moveToNext() async{
    ...
    final bool isloggedin = await getData();
    if(isloggedin)
    {
        ...
        children: [
          ...
          Row(
            ...
            children: [
             ...
             //const Text("TASK UPDATION MODULE",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 20,color: Color.fromARGB(255, 217, 75, 3),),)
            ],
          ),
